"""
Creates the fresh Argus_Colab_Training.ipynb Jupyter Notebook
Starts 100% FRESH from the beginning: Epoch 1 to 25 (~2 hours, ~88%-91% mAP)
"""
import json
...
target_file = Path(r"c:\hackthon-\ml\training\Argus_Colab_Training.ipynb")
with open(target_file, "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print(f"Created fresh notebook: {target_file}")
